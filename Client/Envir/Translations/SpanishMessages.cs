...
namespace Client.Envir.Translations
{
    ...
    public class SpanishMessages : StringMessages
    {
        ...
        public override string WeaponEnergyFlamingSword { get; set; } = "La energía se acumula dentro de tu arma, Flaming Sword está lista.";
        public override string WeaponEnergyDragonRise { get; set; } = "La energía se acumula dentro de tu arma, Dragon Rise está listo.";
        public override string WeaponEnergyBladeStorm { get; set; } = "La energía se acumula dentro de tu arma, Blade Storm está lista.";
        public override string WeaponEnergyDefensiveBlow { get; set; } = "La energía se acumula dentro de tu arma, el golpe defensivo está listo.";
        ...
        public override string UseThrusting { get; set; } = "Usar Empuje.";
        public override string DoNotUseThrusting { get; set; } = "No utilices Empujes.";
        public override string UseHalfMoon { get; set; } = "Usa Half Moon Strike.";
        public override string DoNotUseHalfMoon { get; set; } = "No uses Half Moon Strike.";
        public override string UseDestructiveSurge { get; set; } = "Usa Destructive Surge.";
        public override string DoNotUseDestructiveSurge { get; set; } = "No uses Destructive Surge.";
        public override string UseFlameSplash { get; set; } = "Usa Flame Splash.";
        public override string DoNotUseFlameSplash { get; set; } = "No uses Flame Splash.";
        ...
        public override string GameSceneCastInCooldown { get; set; } = "No se puede lanzar {0}, todavía está en tiempo de reutilización";
